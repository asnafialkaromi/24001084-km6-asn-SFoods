...
class DummyMenuDataSource : MenuDataSource {
    override fun getMenus(): List<Menu> {
        return mutableListOf(
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_fried_rice.jpg?raw=true",
                name = "Nasi Goreng",
                rating = 4.9,
                price = 15000.0,
            ...
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_fried_noodle.jpg?raw=true",
                name = "Mie Goreng",
                rating = 4.3,
                price = 10000.0,
            ...
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_choco_drink.jpg?raw=true",
                name = "Es Coklat",
                rating = 4.7,
                price = 5000.0,
            ...
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_burger.png?raw=true",
                name = "Burger",
                rating = 4.9,
                price = 20000.0,
            ...
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_boiled_noodle.jpg?raw=true",
                name = "Mie Rebus",
                rating = 4.4,
                price = 12000.0,
            ...
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_fried_chiken.png?raw=true",
                name = "Ayam Geprek",
                rating = 4.9,
                price = 8000.0,
            ...
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_sushi.png?raw=true",
                name = "Sushi",
                rating = 4.7,
                price = 40000.0,
            ...
            Menu(
                imgUrl = "https://github.com/asnafialkaromi/sfoods-assets/blob/main/product_img/img_snack_pack.png?raw=true",
                name = "Doritos",
                rating = 4.5,
                price = 4000.0,
